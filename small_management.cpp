...
class Prescription {
    ...
    Patient* patient;
    public:
    Prescription (string m, string p, Doctor* d, Patient* pa): medicine(m), posage(p), doctor(d), patient(pa) {}

    void displayprescription() {
        cout << "Precription Information" << endl;
        cout << "Medicine: " << medicine << endl;
        cout << "Posage: " << posage << endl;
...
class Clinic {
    ...
    void addprescription( Patient* pa, Doctor* doc, string me, string po) {
         Prescription* pre = new Prescription(me, po, doc, pa);
         cout << "Create Prescription Successfully" << endl;
...
int main() {
    ...
    cl.addprescription(pa2, doc2, "Metformin", "500mg twice daily");
